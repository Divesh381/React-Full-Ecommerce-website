...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_0X4yDVsOQvyVOS",
      key_secret: "ezhYqyaEI3Iqpli8KUIYPYVT",
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3 ">
            {cartItems.map((item, index) => {
              ...
              return (
                <div key={index}>
                  <div className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6
              sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '' }}>
